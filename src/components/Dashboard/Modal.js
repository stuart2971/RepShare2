...
import { createHaul } from "../utils/DashboardUtils";

export default function Modal({ isModalOpen, setIsModalOpen, setHaulsData }) {
    const [haulName, setHaulName] = useState("");
    const { user } = useAuth0();

    async function confirmCreateHaul() {
